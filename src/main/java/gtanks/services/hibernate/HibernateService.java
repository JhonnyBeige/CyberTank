...
import gtanks.users.missions.challenges.ChallengesUser;
import gtanks.users.missions.daily.DailyMissionUser;
...
public class HibernateService {
    ...
    static {
        try {
            ...
            cfg.addAnnotatedClass(DailyMissionUser.class);
            cfg.addAnnotatedClass(WeeklyMissionUser.class);
            cfg.addAnnotatedClass(ChallengesUser.class);
            ...
            cfg.setProperty("hibernate.connection.password", "CyberTankz114");
