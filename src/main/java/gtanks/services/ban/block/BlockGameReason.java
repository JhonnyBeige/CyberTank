...
public class BlockGameReason {
    public static final BlockGameReason DEFAULT = new BlockGameReason(0,
            "The account was blocked for violating the rules of the game\nIf you are sure that we made a mistake, write to support@cybertankz.com");
    ...
    public static final BlockGameReason USING_BAGS = new BlockGameReason(5,
            "Malicious use of a software error %nIf you are sure that we made a mistake, write to support@cybertankz.com");
    public static final BlockGameReason SABOTAGE = new BlockGameReason(6,
            "Sabotage (interfering with another team through inactive “fake” players)%nIf you are sure that we made a mistake, write to support@cybertankz.com");
