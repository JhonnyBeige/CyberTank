...
public class BattlePrizeCalculate {
    ...
    public  void calc(List<BattlefieldPlayerController> users, int fund) {
        ...
        DailyMissionsServices.instance().firstPlace(_first.getUser(), 1);
        ...
        for (BattlefieldPlayerController user : users) {
            ...
            DailyMissionsServices.instance().winCrystalls(user.getUser(), prize);
        }
        ...
        DailyMissionsServices.instance().firstPlace(_first.getUser(), first.getPrize());
    }
