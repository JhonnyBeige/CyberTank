...
public class User
    ...
    public void addScore(int score) {
        ...
        ChallengesServices.instance().userEarnScore(this, score * (PremiumService.getInstance().getPremiumTime(this.id).isActivated() ? 2 : 1));
        // Major and above
        if (this.rang > 18) {
    ...
    public void setCheckoutSession(String session){
