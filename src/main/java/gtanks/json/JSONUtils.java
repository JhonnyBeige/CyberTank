...
public class JSONUtils {
    ...
    public static String parseBattleModelInfo(BattleInfo battle, boolean spectatorMode) {
        ...
        json.put("parkour", battle.battleFormat == 4);
        return json.toJSONString();
    }
    ...
    public static String parseTankData(BattlefieldModel player, BattlefieldPlayerController controller,
        ...
        json.put("hull_id", mountedHullSkin
                .orElse(garageUser.mountHull.id + "_m" + garageUser.mountHull.modificationIndex));
        ...
        json.put("turret_skin", mountedTurretSkin.orElse(
                garageUser.mountTurret.id + "_m" + garageUser.mountTurret.modificationIndex));
    ...
    public static String parseJuggernautTankData(BattlefieldModel player, BattlefieldPlayerController controller,
            Garage garageUser, Vector3 pos, boolean stateNull, String idTank, String nickname, int rank) {
        JSONObject json = new JSONObject();
        json.put("battleId", player.battleInfo.battleId);
        json.put("colormap_id", garageUser.mountColormap.id + "_m0");
        String mountedHullSkin = "juggernaut_m0";
        json.put("hull_id", mountedHullSkin);
        json.put("turret_id", "terminator_m0");
        String mountedTurretSkin = "terminator_m0";
        json.put("turret_skin", mountedTurretSkin);
        String shotEffectId = "terminator_m0";
        controller.tank.shotEffect = shotEffectId;
        controller.tank.hullSkin = mountedHullSkin;
        controller.tank.turretSkin = mountedTurretSkin;
        json.put("shot_effect", shotEffectId);
        json.put("team_type", controller.playerTeamType);
        if (pos == null) {
            pos = new Vector3(0.0f, 0.0f, 0.0f);
